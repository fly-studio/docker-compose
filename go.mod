...
require (
	...
	k8s.io/apimachinery v0.24.2 // indirect; see replace for the actual version used
	k8s.io/client-go v1.5.2 // indirect; see replace for the actual version used
...
require (
	...
	github.com/goplus/reflectx v0.8.10 // indirect
