...
func init() {
	igop.RegisterPackage(&igop.Package{
		...
		NamedTypes: map[string]igop.NamedType{
			...
			"Config":                  {reflect.TypeOf((*q.Config)(nil)).Elem(), "MarshalJSON", ""},
			"ConfigDetails":           {reflect.TypeOf((*q.ConfigDetails)(nil)).Elem(), "LookupEnv", ""},
			...
			"Duration":                {reflect.TypeOf((*q.Duration)(nil)).Elem(), "MarshalJSON,MarshalYAML,String", "UnmarshalJSON"},
			"ExtendsConfig":           {reflect.TypeOf((*q.ExtendsConfig)(nil)).Elem(), "", ""},
			"Extensions":              {reflect.TypeOf((*q.Extensions)(nil)).Elem(), "Get", ""},
			"External":                {reflect.TypeOf((*q.External)(nil)).Elem(), "MarshalJSON,MarshalYAML", ""},
			...
			"HostsList":               {reflect.TypeOf((*q.HostsList)(nil)).Elem(), "AsList", ""},
			"IPAMConfig":              {reflect.TypeOf((*q.IPAMConfig)(nil)).Elem(), "", ""},
			"IPAMPool":                {reflect.TypeOf((*q.IPAMPool)(nil)).Elem(), "", ""},
			"Labels":                  {reflect.TypeOf((*q.Labels)(nil)).Elem(), "Add", ""},
			...
			"MappingWithEquals":       {reflect.TypeOf((*q.MappingWithEquals)(nil)).Elem(), "OverrideBy,RemoveEmpty,Resolve", ""},
			...
			"Project":                 {reflect.TypeOf((*q.Project)(nil)).Elem(), "AllServices,ConfigNames,GetService,GetServices,NetworkNames,SecretNames,ServiceNames,VolumeNames,WithServices,withServices", "ApplyProfiles,ForServices,RelativePath,ResolveImages,WithoutUnnecessaryResources"},
			...
			"SSHConfig":               {reflect.TypeOf((*q.SSHConfig)(nil)).Elem(), "Get", ""},
			"SSHKey":                  {reflect.TypeOf((*q.SSHKey)(nil)).Elem(), "MarshalJSON,MarshalYAML", ""},
			"SecretConfig":            {reflect.TypeOf((*q.SecretConfig)(nil)).Elem(), "", ""},
			"Secrets":                 {reflect.TypeOf((*q.Secrets)(nil)).Elem(), "", ""},
			"ServiceConfig":           {reflect.TypeOf((*q.ServiceConfig)(nil)).Elem(), "GetDependencies,HasProfile", "NetworksByPriority"},
			...
			"ServiceVolumeConfig":     {reflect.TypeOf((*q.ServiceVolumeConfig)(nil)).Elem(), "String", ""},
			...
			"Services":                {reflect.TypeOf((*q.Services)(nil)).Elem(), "GetProfiles,MarshalJSON,MarshalYAML", ""},
			...
			"UlimitsConfig":           {reflect.TypeOf((*q.UlimitsConfig)(nil)).Elem(), "", "MarshalJSON,MarshalYAML"},
			"UnitBytes":               {reflect.TypeOf((*q.UnitBytes)(nil)).Elem(), "MarshalJSON,MarshalYAML", ""},
